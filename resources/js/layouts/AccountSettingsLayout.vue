    ...
    <AppLayout>
        ...
        <template #content>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide !w-fit">
                                <Link
                                    ...
                                    :preserveScroll="true"
                                    class="flex flex-nowrap items-center gap-3 rounded bg-primary-200/70 px-4 py-2 font-semibold text-nowrap text-foreground backdrop-blur-lg hover:scale-95 hover:opacity-90 dark:bg-primary-800/70"
                                    ><User class="h-5 w-5" /> Informasi Diri</Link
                                >
                            </div>
                            <div class="swiper-slide !w-fit">
                                <Link
            ...
            <section class="px-4 py-8 lg:py-12">
                <h2 class="mb-2 text-start text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white"><slot name="settingsHeader" /></h2>
                <p class="mb-6 text-start font-light text-gray-500 sm:text-xl lg:mb-10 dark:text-gray-400">
