                        ...
                        <div class="min-w-0 flex-1 space-y-8">
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center">
                                            <button
                                                ...
                                                class="z-10 inline-flex shrink-0 items-center rounded-s-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:ring-4 focus:ring-gray-100 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700"
                                                type="button"
                                            >
                                    ...
                                    <div>
                                        <label for="vat_number" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
                                            VAT number
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ms-4 text-sm">
                                                <label for="pay-on-delivery" class="leading-none font-medium text-gray-900 dark:text-white">
                                                    QRIS
                                                </label>
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ms-4 text-sm">
                                                <label for="dhl" class="leading-none font-medium text-gray-900 dark:text-white"> Di Toko </label>
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ms-4 text-sm">
                                                <label for="fedex" class="leading-none font-medium text-gray-900 dark:text-white"> GoSend </label>
                                                <p id="fedex-text" class="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">
                                                    +biaya disesuaikan
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ms-4 text-sm">
                                                <label for="express" class="leading-none font-medium text-gray-900 dark:text-white">
                                                    Lainnya (JNT / JNE / Dll)
                                                </label>
